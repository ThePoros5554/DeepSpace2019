...
public class RobotMap
{
    ...
    public static final String RAMPTOLEFTROCKET = "RampToLeftRocket";
    public static final String RAMPTORIGHTROCKET = "RampToRightRocket";
    ...
    public static final String TEST = "testit";
