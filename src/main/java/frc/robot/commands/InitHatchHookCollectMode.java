...
public class InitHatchHookCollectMode extends CommandGroup
{
  /**
   * Add your docs here.
   */
  public InitHatchHookCollectMode()
  {
    addParallel(new AdjustWrist(WristMode.DOWN));
    addSequential(new AdjustElevator(ElevatorMode.COLLECT_HATCH_HOOK));
  }
}
