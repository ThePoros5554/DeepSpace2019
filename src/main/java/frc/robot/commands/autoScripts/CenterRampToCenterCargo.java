...
public class CenterRampToCenterCargo extends CommandGroup {
  /**
   * Add your docs here.
   */
  public CenterRampToCenterCargo() {
    Path rr1lp = new Path(RobotMap.CENTERRAMPTOCENTERCARGO + ".left");
    Path rr1rp = new Path(RobotMap.CENTERRAMPTOCENTERCARGO + ".right");
    ...
    //Path rr2lp = new Path(RobotMap.CENTERCARGOBACK + ".left");
    //Path rr2rp = new Path(RobotMap.CENTERCARGOBACK + ".right");

    //addSequential(new FollowPath(Robot.drivetrain, rr2rp, rr2lp, 0.001, 0.08, 0.005, 0.05, true));
    // Add Commands here:
