...
public class LeftRampToCenterCargoTest extends CommandGroup {
  /**
   * Add your docs here.
   */
  public LeftRampToCenterCargoTest() {
    Path rr1lp = new Path(RobotMap.LEFTRAMPTOCENTERCARGOTEST + ".left");
    Path rr1rp = new Path(RobotMap.LEFTRAMPTOCENTERCARGOTEST + ".right");
