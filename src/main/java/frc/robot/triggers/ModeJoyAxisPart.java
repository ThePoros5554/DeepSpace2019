 ...
 * Add your docs here.
 */
public class ModeJoyAxisPart extends JoyAxisPart {
  
  private RobotMode triggerMode;

  public ModeJoyAxisPart(GenericHID joystick, int axisNumber, double newMinValue, double newMaxValue, double oldMinValue, double oldMaxValue,
