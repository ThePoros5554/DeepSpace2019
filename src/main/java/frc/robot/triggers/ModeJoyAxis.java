 ...
 * Add your docs here.
 */
public class ModeJoyAxis extends JoyAxis {
  
  private RobotMode triggerMode;

  public ModeJoyAxis(GenericHID joystick, int axisNumber, double newMinValue, double newMaxValue, double oldMinValue, double oldMaxValue,
